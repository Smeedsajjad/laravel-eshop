<header class="navbar bg-base-100 px-4 py-2 shadow-md z-10 flex-wrap sm:flex-nowrap">
    ...
    {{-- Right buttons --}}
    <div class="flex-none flex items-center gap-2 sm:gap-4 ml-auto pr-2">
        {{-- Language Selector --}}
        <select class="select select-bordered select-sm sm:select-md bg-base-200 w-20 sm:w-auto">
            <option>EN</option>
            <option>UR</option>
            <option>FR</option>
        </select>
            ...
            <label tabindex="0" class="btn btn-ghost btn-circle avatar btn-sm sm:btn-md">
                ...
                <span class="inline-flex rounded-md">
                    <button type="button" class="btn ">
                        {{ Auth::user()->name }}
                        <svg class="ms-1 sm:ms-2 -me-0.5 size-3 sm:size-4" xmlns="http://www.w3.org/2000/svg"
